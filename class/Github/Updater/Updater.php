...
namespace EmailWP\Github\Updater;
...
class Updater
{
    ...
    public function modify_transient($transient)
    {
        if (is_object($transient) && property_exists($transient, 'checked') && $checked = $transient->checked) { // Did Wordpress check for updates?
            ...
            if ($this->github_response == 'Not Found') {
                return $transient;
            }
            ...
            if ($args->slug == $this->basename) { // And it's our slug
                ...
                $plugin = array(
                    ...
                    'sections'            => array(
                        ...
                        'Updates'        => !empty($this->github_response['body']) ? $this->github_response['body'] : $this->github_response['name'],
                    ),
